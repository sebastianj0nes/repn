    ...
    <div className="container mx-auto px-4 py-8 pb-24">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>Receive suggestions for increasing weights and repetitions</li>
          <li>Display workout information and history</li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>Our collection and use of personal information in connection with your access to and use of the App is described in our Privacy Policy.</p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>These Terms shall be governed by and construed in accordance with the laws of UK, without regard to its conflict of law provisions.</p>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">12. Contact Us</h2>
        <p>If you have any questions about these Terms, please contact us at tryliftlog@gmail.com.</p>
      </section>
    </div>
  )
}
